 ...
 ************************************************************************/
#ifndef __BSP_88E6060_H
#define __BSP_88E6060_H
...
/**
  * @}brief 88E6060 Switch Register Address
  */
#define	PORT_Num_Max 								6 
#define	PHY_BIR										2
  
#define 	SMI_DEV_ADDR_BASIC 						0x00
#define 	SWITCH_PORT_ADDR 						SMI_DEV_ADDR_BASIC+8
#define 	SWITCH_GLOBAL_ADDR 						SMI_DEV_ADDR_BASIC+0x0F
#define 	PORT_STATUS_REG_ADDR 					0
#define 	PORT_CONTROL_REG_ADDR	 				4
#define 	GLOBAL_STATUS_REG 						0
#define 	GLOBAL_CONTROL_REG						4

/**
  * @}brief Port Control Register Bits Definition
  */
#define PORT_Ctl_Forwarding     ((uint16_t)0x0003)      /*!< port state forwarding */
