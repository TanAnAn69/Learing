...
void *rt_malloc_ex(rt_size_t nbytes,const char *func,rt_size_t line);
#define rt_malloc(s) rt_malloc_ex(s,__FUNCTION__,__LINE__)
 ...
 * semaphore interface
 */
#define rt_sem_init(sem,name,value,flag)  rt_sem_init_ex(sem,name,value,flag,__FUNCTION__,__LINE__)
rt_err_t rt_sem_init_ex(rt_sem_t   sem,
                     const char *name,
                     rt_uint32_t value,
                     rt_uint8_t  flag,const char *func,rt_uint16_t line);
